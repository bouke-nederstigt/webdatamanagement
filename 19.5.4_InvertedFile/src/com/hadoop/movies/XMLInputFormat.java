...
/**
 * A simple {@link org.apache.hadoop.mapreduce.InputFormat} for XML documents (
 * {@code org.apache.hadoop.mapreduce} API). The class recognizes
 * begin-of-document and end-of-document tags only: everything between those
 * delimiting tags is returned in an uninterpreted {@code Text} object.a
 *
 * @author Jimmy Lin
 */
public class XMLInputFormat extends TextInputFormat {
    ...
    /**
     * Simple {@link org.apache.hadoop.mapreduce.RecordReader} for XML documents
     * ({@code org.apache.hadoop.mapreduce} API). Recognizes begin-of-document
     * and end-of-document tags only: everything between those delimiting tags
     * is returned in a {@link Text} object.
     *
     * @author Jimmy Lin
     */
    public static class XMLRecordReader extends
        ...
        // Logger.getLogger(XMLRecordReader.class);
        ...
        public void initialize(InputSplit input, TaskAttemptContext context)
            ...
            if (conf.get(START_TAG_KEY) == null
                    || conf.get(END_TAG_KEY) == null)
                throw new RuntimeException(
                        "Error! XML start and end tags unspecified!");
            ...
            if (codec != null) {
                ...
                fsin = new DataInputStream(codec.createInputStream(fs
                        .open(file)));
            ...
            // Because input streams of gzipped files are not seekable, we need
            // to keep track of bytes
            // consumed ourselves.
            pos = start;
        }
            ...
            if (pos < end) {
                if (readUntilMatch(startTag, false)) {
                    ...
                    try {
                        ...
                        // seekable, we need to keep track of
                        // bytes consumed ourselves.

                        // This is a sanity check to make sure our internal
                        // computation of bytes consumed is
                        // accurate. This should be removed later for efficiency
                        // once we confirm that this code
                        // works correctly.
